...
//	JonS_00_P1_main.cpp   **** MODIFY WITH YOUR FILENAME  ****
...
{ //***main
  ...
  int log_complete = 0;
  char f_name[30] = "Scarlett";  //** change xxxFNAMExxx to your first name
  char l_name[30] = "Jones";  //** change xxxLNAMExxx to your last name
  ofstream logfile, myfile;

     //********************************************************************
     //*********** Enter Student Data in Class Shared Log File ************
     //********************************************************************
  logfile.open ("/home/pwb0013/csce2100/program1/2100_002._class_log.txt", ios::out | ios::app);
  ...
  if (log_complete == 1)
    {
     myfile.open ("CSCE2100_002_Program1_Verification.txt", ios::trunc);
     ...
     if (myfile.is_open())
       {    // normal file opening ... ready for data
        ...
        myfile << "   submitting the results to the CSCE2100.002 BlackBoard.";
